    ...
    <body>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <!-- <span><img src=" //echo 'images/profileImages/'.$_SESSION['picName'].'?' ?>" class="image-circle" class="img-responsive" height="200%"></span> -->
                    <span ><img src="<?php echo 'images/profileImages/profile0.png'.'?'.mt_rand(); ?>" class="img-circle" class="img-responsive" height="200%"></span>
                    <br>
